...
namespace KILVRA.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(OnlineClothesShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Name,Description,CreatedAt")] Category category)
        {
