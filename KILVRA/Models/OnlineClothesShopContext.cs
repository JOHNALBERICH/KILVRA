...
using KILVRA.Area.Admin.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MSI;Database=OnlineClothesShop;Trusted_Connection=True;Encrypt=False;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categories__19093A2B");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.Category)
                ...
                .HasConstraintName("FK__Products__Category__XXXXXX"); // optional custom name
...
public DbSet<KILVRA.Area.Admin.Models.Coupon> Coupon { get; set; } = default!;
}
