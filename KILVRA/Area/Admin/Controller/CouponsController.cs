...
namespace KILVRA.Area.Admin.Controller
{
    public class CouponsController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public CouponsController(OnlineClothesShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CouponId,Code,DiscountPercent,ExpiryDate,IsActive")] Coupon coupon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CouponId,Code,DiscountPercent,ExpiryDate,IsActive")] Coupon coupon)
        {
